...
| [18_OPENCODE.md](./18_OPENCODE.md) | OpenCode harness slice A (serve per workdir · thinking · no OKF from thinking) |
...
**Design locked next:** OpenCode harness slice A → SemVer **`0.3.0`** — [18_OPENCODE.md](./18_OPENCODE.md).  
