...
**Harness / OpenCode:** extract input remains **user message + final assistant text** only. **Never** feed thinking/reasoning streams into OKF ([18_OPENCODE.md](./18_OPENCODE.md)).
